%model 4: graph titles, unpacking of state,
...
hold on;
title('Inertial Position vector of sc', 'FontSize', 14, 'FontWeight', 'bold', 'Color', 'g');
...
%% 
    ...
    [c,cdash]       = getcs(r_wc_b, W);
    [w_1, w_2, w_3] = ws(w_b_n)       ; %pass w_b_n current to get W frame omega components

...
%wheel properties
W_frame_init = [.7887 -.2113 -1/sqrt(3); -0.2113 .7887 -1/sqrt(3); 1/sqrt(3) 1/sqrt(3) 1/sqrt(3)]; %wheel orientation matrix
g = W_frame_init(:,1);
...
W_init = 300; %-558; % cap omega (random rad/s chosen) (initial wheel speed
%%FIX???
...
%%%%%%%%%%%%%%%%%%%%%%
save('parameters2.mat', 'g','r_c_ndd','w_b_nd', 'msc', 'mrw', 'mhub', 'ihub_bc', 'r_bc_b', 'W_frame_init','W_init', 'd', 'U_s', 'U_d', 'irw_wc', 'r_w_b', 'J11', 'J12', 'J13', 'J22', 'J23', 'J33', 'us_0');
